                    ...
                    <blockquote>
                        <blockquote>
                            <blockquote>
                                ...
                                <p class="light" align="justify">This is the signature event of Decoders held annualy.
                                    Teams of two members participat in the purely coding event. Here Reverse has special
                                    significance which means participants have to code by analysizing the output.<br>
                                    The Winners are awarded cash prizes and certificates. The Winners get added
                                    advantage for recruitment into the team 'Decoders'.</p>
