...
<body>
			...
			<div class="row">
				...
				<div class="col s4">
					<div class="icon-block">
						...
						<p class="light">Submit a problem after evening sessions is over or a new challenge you would like to post. You need to give the serial number, problem statement and also its solution. You should paste the solution from a plaintext editor such as Notepad,Atom,Gedit,VS Code, Sublime e.t.c. <b>Do not write there in the provided text area. DO NOT PASTE DIRECTLY FROM A WEB PAGE,PDF or DOCX. </b>  </p>
						<p>
							<a href="/_dcdrad_/problemForm.jsp"
							   class="btn-large waves-effect waves-light orange">Submit a <question></question></a>
						</p>
					</div>
				</div>
	...
	<footer class="page-footer blue">
		<div class="footer-copyright">Team: Decoders |
			 | Powered by: Google App Engine</div>
	</footer>
