...
<body class="grey lighten-3">
    ...
    <div align="center">
		...
		<img alt="javaimage" src="images/images.png"
	...
	<div class="container">
			<div class="col s6">
			  <div class="icon-block">
				...
				<h5 class="center">Core Java Programming</h5>
					<blockquote>
					 <blockquote>
					  <blockquote>
					   <blockquote>
					      <blockquote>
					          ...
					          <blockquote>
					                ...
					                <p class="light" align="left">Core java concepts are covered specially for 3rd years.<br>Session is taken regularly on weekdays.<br>A student is motivated to work out the problems given on the site.</p>
