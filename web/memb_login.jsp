...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
	rel="stylesheet">
<title>Decoders:Members Login</title>
</head>
<body>
	<!-- Header Section -->
	<nav class="teal teal-text text-darken-4" role="navigation">
		<div class="nav-wrapper container">
			<a id="logo-container" href="index.html" class="brand-logo"><img
				...
				style="border: thin; border-style: solid; border-radius: 2px;">&nbsp;Decoders | Member Login</a>
			...
			<table>
				<tr>
					...
					<td><input type="password" name="password"
						placeholder="Your password" required="required"></td>
				</tr>
			</table>
