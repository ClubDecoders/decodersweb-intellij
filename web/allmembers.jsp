	...
	<div class="container">
		<div class="col s6">
			<div class="icon-block">
				...
				<h5 class="center">All our marvellous members!</h5>
				<blockquote>
					<blockquote>
						<blockquote>
							<blockquote>
								<blockquote>
									...
									<p class="light" align="justify">
										<strong>Second Year Members</strong><br>
										<ol>
											<li>Vaibhav Shrivastav</li>
											<li>Vinay Satish</li>
											<li>Nishank Pandey</li>
											<li>Archana S.</li>
											<li>Kushal N.</li>	
										</ol>
										<br><br>
										<strong>Third Year Members</strong><br>
										<ol>
											<li>Shwetabh Shekhar</li>
											<li>Rishav Goswami</li>
											<li>Jagatjyoti G. Tuladhar</li>
											<li>Tanisha Datta</li>
											<li>Pranav with some title!</li>
											<li>Sagar R.N.</li>
											<li>Neeraj Agarwal</li>
											
										</ol>
										<br><br>
										<strong>Final Year Members</strong>
										<ol>
											<li>Aditya Raj</li>
											<li>Aditya Shankar Bannerjee<li>
											<li>Abhishek Kumar</li>
											<li>Anurag Ambuj</li>
											<li>Pranjal Shubham</li>
											<li>Shubham Kumar</li>
											<li>Karthik N.</li>
											<li>Shakeelpatel Biradar</li>
											<li>Pranav Kumar</li>
											<li>Raja Ram</li>
											<li>Swati N. Murthy</li>
											<li>Sathyanath N. Kurpad </li>
											<li>Aakash Shrivastava</li>										
										</ol>
