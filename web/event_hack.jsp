	...
	<div class="container">
			<div class="col s6">
			  <div class="icon-block">
				...
				<h5 class="center">CSI hackathon</h5>
					<blockquote>
					 <blockquote>
					  <blockquote>
					   <blockquote>
					      <blockquote>
					                ...
					                <p class="light" align="justify">The CSI Hacathon in partner with team Decoders is 12hr app development contest organized in Siddaganga Institute of Technology and CSI. Teams of 3-4 members participated in the event to solve some college related or local problems statements .The Winners were awarded cash prizes and certificate.</p>
