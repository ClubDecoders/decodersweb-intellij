	...
	<div class="container">
			<div class="col s6">
			  <div class="icon-block">
				...
				<h5 class="center">Saturday Member Sessions</h5>
					<blockquote>
					 <blockquote>
					  <blockquote>
					   <blockquote>
					      <blockquote>
					          ...
					          <blockquote>
					                ...
					                <p class="light" align="left">Every Saturday, a metting is held for decodes members in which 3 hrs 2pm - 5pm is devoted to coding.<br>These problem solving session not only for decoders' members but for non decoders' members too.</p>
