...
<body class="grey lighten-3">
    ...
    <div align="center">
		...
		<img alt="algimage" src="images/algorithm.jpg"
	...
	<div class="container">
			<div class="col s6">
			  <div class="icon-block">
				...
				<h5 class="center">Data Strucutures and Algorithms</h5>
					<blockquote>
					 <blockquote>
					  <blockquote>
					   <blockquote>
					      <blockquote>
					          ...
					          <blockquote>
					                ...
					                <p class="light" align="left">Data Structures an algorithms sessions organized on every saturday 2pm-5pm.<br>
					                  This is open for all  2 and 3 year students.<br>
					                  The question are meant to test the alogithms efficiencyd design and their implementation.<br>
					                  The solutions are optimized with the constraint of space and time.</p>
		...
		<div class="row">
			<div class="col s6">
				<div class="icon-block">
					<img alt="dsimage2" src="images/ds_2.png"
			style="border: thick; border-style: solid; border-radius: 10px"
			...
			<div class="col s6">
				<div class="icon-block">
					<img alt="dsimage1" src="images/ds_1.png"
			style="border: thick; border-style: solid; border-radius: 10px"
			width="100%" height="250px">
				</div>
			</div>
	...
	<footer class="page-footer teal">
		...
		<div class="footer-copyright">
			<div class="container">
				...
				| Theme: Materialize | <a href="allmembers.jsp">All Members</a> | <a href="_dcdrad_/adminlogin.jsp">Admin</a>
			</div>
		</div>
	</footer>
