...
<body class="grey lighten-3">
    ...
    <div align="center">
		...
		<img alt="javaimage" src="images/reverse.jpg"
	...
	<div class="container">
			<div class="col s6">
			  <div class="icon-block">
				...
				<h5 class="center">Reverse Coding</h5>
					<blockquote>
					 <blockquote>
					  <blockquote>
					   <blockquote>
					      <blockquote>
					                ...
					                <p class="light" align="justify">This is the signature event of Decoders held annualy. Teams of two members participat in the purely coding event. Here Reverse has special significance which means participants have to code by analysizing  the output.<br>
The Winners are awarded cash prizes and certificates. The Winners get added advantage for recruitment into the team 'Decoders'.</p>
