...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
	rel="stylesheet">
<title>Decoders Registration</title>
</head>
<body>
		...
		<form action="/regserv" method="post">
			<table>
				<tr>
					...
					<td><input type="text" name="name" placeholder="What's your Name?"
				...
				<tr>
					...
					<td><select name="branch" id="branch"
						class="select browser-default" required="required">
							...
							<option value="Others">Other Branches</option>
					</select></td>
				</tr>
				<tr>
					...
					<td><select id="semester" name= "sem" class="select browser-default" required="required">
							...
							<option value="9">Arch. Nineth Semester</option>
							<option value="10">Arch. Tenth Semester</option>
					</select></td>
				</tr>
				<tr>
